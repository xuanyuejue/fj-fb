<template>
    <div class="gameWrapper">
        <section class="count_down_game">
            <span class="decade_game" :class="current_time_d"></span>
            <span class="unit_game" :class="current_time_u"></span>
        </section>
        <div class="gameZone_my" v-touch:tap="countPlus()">
            <!-- -->
        ...
        <div class="cover" v-if="showCover" @click="gameTrigger()">
            <img src="http://ker.iihwx.com/iih_wechatbs/Public/home/common/shangshi/img/instructionCover.png">
        </div>
        ...
        <audio :src="bgmSrc" id="bgm" loop="loop" autoplay></audio>
        <audio :src="effectSrc" id="effect"></audio>
